    ...
    return(
        ...
        <div className="form-container">
            ...
            <div className="gender-container">
                <label>Male:</label> <input type="radio" value="Male" checked ={gender === "Male"} onChange={handleGenderChange}></input><br /><br />
                <label>Female:</label><input type="radio" value="Female" checked ={gender ==="Female"} onChange={handleGenderChange}></input><br /><br />
            </div>
